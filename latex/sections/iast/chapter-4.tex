...
\begin{table}[H]
\begin{tabular}{cl}
\textbf{4.6} & \romline{ajo'pi san-navyayātmā} \\
 & \romline{bhūtānā-mīśvaro'pi san |} \\
 & \romline{prakṛtiṃ svāmadhiṣṭhāya} \\
 & \romline{sambhavāmyāt-mamāyayā ||}
\end{tabular}
\end{table}
...
\begin{table}[H]
\begin{tabular}{cl}
\textbf{4.27} & \romline{sarvāṇ-īndriyakarmāṇi} \\
 & \romline{prāṇakarmāṇi cāpare |} \\
 & \romline{ātma-saṃya-mayogāgnau} \\
...
\begin{table}[H]
\begin{tabular}{cl}
\textbf{4.41} & \romline{yogasannyasta-karmāṇaṃ} \\
...
\begin{table}[H]
\begin{tabular}{cl}
\textbf{4.42} & \romline{tasmāda-jñānasambhūtaṃ} \\
