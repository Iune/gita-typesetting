...
\begin{table}[H]
\begin{tabular}{cl}
\textbf{18.55} & \romline{bhaktyā māma-bhijānāti} \\
...
\textbf{18.60} & \romline{svabhāva-jena kaunteya} \\
 ...
 & \romline{kariṣyas-yavaśo'pi tat ||}
\end{tabular}
\end{table}
...
\textbf{18.68} & \romline{ya imaṃ paramaṃ guhyaṃ} \\
 & \romline{madbhakteṣva-bhidhāsyati |} \\
 & \romline{bhaktiṃ mayi parāṃ kṛtvā} \\
 & \romline{māmevaiṣyatya-saṃśayaḥ ||}
\end{tabular}
\end{table}
...
\begin{table}[H]
\begin{tabular}{cl}
\textbf{18.71} & \romline{śraddhāvānana-sūyaśca} \\
