...
\natline{సాణ్ఖ్యయోగః} & \romline{sāṅkhya-yogaḥ}
\end{tabular}
\end{table}
...
\centering
\begin{tabular}{ll}
\natline{న హిప్రపశ్యామి మమాపనుద్యాద్} & \romline{na hi\textasciitilde{}prapaśyāmi mamāpanudyād} \\
...
\centering
\begin{tabular}{ll}
\natline{జాతస్య హిధ్రువో మృత్యుః} & \romline{jātasya hi\textasciitilde{}dhruvo mṛtyuḥ} \\
